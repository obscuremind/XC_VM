...
class Encryption {
	 ...
	 */
	public static function encrypt(string $data, string $key, string $deviceId) {
	 ...
	 */
	public static function decrypt(string $data, string $key, string $deviceId) {
		$derivedKey = md5(sha1($deviceId) . $key);
		$iv = substr(md5(sha1($key)), 0, 16);
	 ...
	 * @return string
	 */
	public static function randomString(int $length = 10) {
	 ...
	 */
	public static function randomToken(int $bytes = 32) {
	 ...
	 */
	public static function generateKey(int $bits = 128) {
	 ...
	 */
	public static function generateIV(string $cipher = 'AES-128-CBC') {
